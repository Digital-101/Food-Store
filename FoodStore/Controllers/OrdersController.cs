...
using FoodStore.Utilities;
using Microsoft.AspNet.Identity.Owin;

namespace FoodStore.Controllers
{
    [Authorize] //must be logged in first
    public class OrdersController : Controller
    {
        private StoreContext db = new StoreContext();

        //Obtaining Users Manager
        ...
        {
            //Eager Loading to allow searching against OrderLines table
            ...
            //View Orders on selected Dates range
            ...
            //Sort Orders using ViewBag and switch statement//
            //store values for the current sort order -VB
        ...
        public ActionResult Details(int? id)
        {
            ...
            //Include OrderLines to pass it to view using eager loading
            Order order = db.Orders.Include(o => o.OrderLines).Where(o => o.OrderID == id).SingleOrDefault();
            if (order == null)
            {
                return HttpNotFound();
            }
            //User cant view another users orders
        ...
        //Obtain current Basket Details and Transfer them to new Order object
        // GET: Orders/Review
        public async Task <ActionResult> Review()
        {
            ...
            {
                OrderLine line = new OrderLine { Product = basketLine.Product, ProductID = basketLine.ProductID, ProductName = basketLine.Product.Name, Quantity = basketLine.Quantity, UnitPrice = basketLine.Product.Price };
        ...
        public ActionResult Create([Bind(Include = "UserID,DeliveryName,DeliveryAddress")] Order order)
        {
            if (ModelState.IsValid)
            {
                ...
                //Add the orderlines to db after creating the order
                Basket basket = Basket.GetBasket();
