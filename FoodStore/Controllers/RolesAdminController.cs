    ...
    public class RolesAdminController : Controller
    {
        ...
        public async Task <ActionResult> Create(RoleViewModel roleViewModel)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var roleresult = await RoleManager.CreateAsync(role); //key Method
        ...
        public async Task <ActionResult> Edit(RoleViewModel roleModel)
        {
            if (ModelState.IsValid)
            {
                ...
                await RoleManager.UpdateAsync(role);//key Method
                return RedirectToAction("Index");
            }
            return View();
        }
        ...
        public async Task <ActionResult> DeleteConfirmed(string id)
        {
            if (ModelState.IsValid)
            {
                ...
                IdentityResult result = await RoleManager.DeleteAsync(role);//key Method call
                if (!result.Succeeded)
                {
