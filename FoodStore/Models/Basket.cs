...
namespace FoodStore.Models
{
    public class Basket
    {
        ...
        //Add to Basket using pID n Quantity
        ...
        public void MigrateBasket(string userName)
        {
            ...
            if (userBasket != null)
            {
                ...
                //delete the lines in the anonymous basket from db
                BasketID = prevID;
                EmptyBasket();
            }
            else
            {
                //if the user doesn't have a basket then just migrate this one
        ...
        //Create OrderLine n Save Order to DB
